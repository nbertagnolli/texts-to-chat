...
def run():
    ...
    parser.add_argument("--personality", type=str,  default="",
                        help="What personality seed to use")
    ...
    if args.personality == "":
        ...
        personality = [tokenizer.encode("I like game of thrones"), tokenizer.encode("I like camping")]
        print(personality)
